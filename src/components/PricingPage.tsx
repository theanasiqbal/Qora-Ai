...
export default function PricingCards() {
  ...
  return (
    ...
    sx={{
      ...
      "&:before": {
        content: '""',
        position: "absolute",
        width: "600px", // Original design for larger screens
        height: "600px", // Original design for larger screens
        background:
      ...
      "&:after": {
        content: '""',
        position: "absolute",
        width: "400px", // Original design for larger screens
        height: "400px", // Original design for larger screens
        background:
          "radial-gradient(circle, rgba(113, 47, 255, 0.15) 0%, transparent 70%)",
        top: "20%",
        left: "10%",
  ...
  >
    <Container maxWidth="lg">
      <Stack
        direction={{ xs: "column", md: "row" }} // Stacks on smaller screens, row on medium screens
        spacing={3}
        ...
        {plans.map((plan, index) => (
          <Card
            ...
            sx={{
              ...
              flex: 1,
              position: "relative",
              minWidth: { xs: "100%", md: "300px" }, // Full width on small screens, 300px on md+
              display: "flex",
              flexDirection: "column",
              height: {xs:"80vh",
                md:'80vh',
              }, // Adjusts height for responsiveness
            ...
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              <Button
                ...
                sx={{
                  py: 1,
                  height: {
                    xs:'5vh', md:'6vh', sm:'5vh'
                  },
                  textTransform: "none",
                  width: { xs: "50%", sm: "50%", md: "15vw" }, // Button width adjusts responsively
                  background:
